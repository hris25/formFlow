...
import { z } from 'zod'
import { Mail, Lock, Loader2, ArrowRight, CheckCircle2, Sparkles, Layout, BarChart, ShieldCheck } from 'lucide-react'
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 lg:p-12 z-10">
        ...
        >
          ...
          <div className="mb-10 flex flex-col items-center lg:items-start">
            ...
            <p className="text-muted-foreground text-lg">L'excellence de la gestion de formulaires pour enseignants.</p>
          </div>
          ...
          <Card className="border border-border/50 bg-card/50 backdrop-blur-xl shadow-2xl shadow-black/5 overflow-hidden">
            ...
            <CardHeader className="space-y-1 pb-6 pt-8 px-8 relative">
              ...
              <CardDescription className="text-base">
                Accédez à votre espace pédagogique sécurisé.
              </CardDescription>
            </CardHeader>

            <form onSubmit={handleSubmit(onSubmit)}>
              <CardContent className="space-y-5 px-8 relative">
                <motion.div
        ...
        <div className="relative z-10 w-full flex flex-col justify-between p-16 text-white">
          ...
          >
            ...
            <h2 className="text-5xl font-extrabold leading-tight mb-6">
              Simplifiez vos<br />évaluations quotidiennes.
            </h2>
            <p className="text-xl text-primary-foreground/80 max-w-lg leading-relaxed">
              FormFlow aide des milliers d'enseignants à créer des formulaires intelligents et analyser les résultats en un clin d'œil.
            </p>
          </motion.div>
          ...
          >
            {[
              { icon: CheckCircle2, title: "Analyse Intelligente", desc: "Traitement automatique des réponses par IA." },
              { icon: BarChart, title: "Graphiques Détaillés", desc: "Visualisez les progrès de vos élèves instantanément." },
              { icon: ShieldCheck, title: "Sécurité Totale", desc: "Vos données et celles de vos élèves sont protégées." }
            ].map((item, i) => (
